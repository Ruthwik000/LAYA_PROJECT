      ...
      <div className="services-left">
        <div className="services-content">
          ...
          <div className="services-list sans-serif">
            <p>ALUMINIUM INTERIORS / MODULAR CUPBOARDS /<br />EXTERIOR WORKS / CUSTOM DESIGNS / RENOVATION</p>
          </div>
          <a href="#learn-more" className="learn-more-btn sans-serif">EXPLORE SERVICES</a>
        </div>
      </div>
